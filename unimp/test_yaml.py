...
def test(model_cfg, dataset_cfg, device, graph_data):
    ...
    result_npy = os.path.join(dataset_cfg['OUT_PATH'], 'new_{}.npy'.format(dataset_cfg['TEST_PREFIX']))
    ...
    result_csv = os.path.join(dataset_cfg['OUT_PATH'], 'new_{}.csv'.format(dataset_cfg['TEST_PREFIX']))
