...
CUDA_VISIBLE_DEVICES=1 python train_yaml.py --k_fold 2 >'log/'$log_name'_2.log' 2>&1 &&
    CUDA_VISIBLE_DEVICES=1 python train_yaml.py --k_fold 3 >'log/'$log_name'_3.log' 2>&1 &&
        CUDA_VISIBLE_DEVICES=1 python train_yaml.py --k_fold 4 >'log/'$log_name'_4.log' 2>&1 &

# 每张卡训练两到一折
CUDA_VISIBLE_DEVICES=0 python train_yaml.py --k_fold 0 >'log/'$log_name'_0.log' 2>&1 &
CUDA_VISIBLE_DEVICES=1 python train_yaml.py --k_fold 1 >'log/'$log_name'_1.log' 2>&1 &
CUDA_VISIBLE_DEVICES=2 python train_yaml.py --k_fold 2 >'log/'$log_name'_2.log' 2>&1 &
CUDA_VISIBLE_DEVICES=3 python train_yaml.py --k_fold 3 >'log/'$log_name'_3.log' 2>&1 &
